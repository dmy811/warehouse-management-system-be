...
use crate::{infrastructure::config::Config, repositories::{WarehouseRepository, role_repository::RoleRepository, user_repository::UserRepository, user_warehouse_repository::UserWarehouseRepository}, services::{AuthService, AuthServiceTrait, WarehouseService, WarehouseServiceTrait, role_service::{RoleService, RoleServiceTrait}, user_service::{UserService, UserServiceTrait}, user_warehouse_service::{UserWarehouseService, UserWarehouseServiceTrait}}};
...
impl ServiceContainer {
    pub fn new(db: &PgPool, config: &Arc<Config>, redis_pool: &Arc<RedisPool>) -> Self {
        ...
        Self {
            ...
            role: Arc::new(RoleService::new(role_repo))
